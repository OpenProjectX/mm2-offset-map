...
allprojects {
    group = "org.openprojectx.kafka.mm2.core"
}
                ...
                if (findByName("mavenJava") == null) {
                    create<MavenPublication>("mavenJava") {
                        ...
                        pom {
                            ...
                            description.set("MM2-OFFSET-MAP Spring Boot starter")
                            url.set("https://github.com/OpenProjectX/mm2-offset-map")
                            ...
                            scm {
                                url.set("https://github.com/OpenProjectX/mm2-offset-map")
                                connection.set("scm:git:https://github.com/OpenProjectX/mm2-offset-map.git")
                                developerConnection.set("scm:git:ssh://git@github.com:OpenProjectX/mm2-offset-map.git")
                            }
                        }
                    }
                }
